import { Controller, Post, Body, HttpCode, HttpStatus, Delete, Patch, Param, Get, Query } from '@nestjs/common';
...
export class ClientRequestController {
  ...
  @Patch('restore/:id')
  @ApiOperation({ summary: 'Method: restore client request' })
  @ApiOkResponse({
    description: 'Client request was restored successfully',
  })
  @HttpCode(HttpStatus.NO_CONTENT)
  async restore(@Param('id') id: string) {
    return await this.clientRequestService.restoreOne(id);
  }
  ...
  @HttpCode(HttpStatus.OK)
  async changeData(@Body() data: UpdateClientRequestDto, @Param('id') id: string): Promise<UpdateResult> {
